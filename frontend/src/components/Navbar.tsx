	...
	return (
		<>
			...
			<div className="flex items-center gap-2 mt-4">
				<p className="bg-white text-black px-4 py-1 rounded-2xl cursor-pointer inline-block">
					All
				</p>
				<p className="bg-white text-black px-4 py-1 rounded-2xl cursor-pointer hidden md:inline-block">
					Music
				</p>
				<p className="bg-white text-black px-4 py-1 rounded-2xl cursor-pointer hidden md:inline-block">
					Podcasts
